...
class TestRecipesInformation(SpoonacularTests):
    ...
    def test_recipes_information(self):
        ...
        recipe_information_request_url = self.get_request_url(base_url, request_parameters)
        recipe_information_reply = self.get_request(recipe_information_request_url)
    ...
    def test_recipes_information_bad_request(self):
        ...
        recipe_information_bad_request_url = self.get_request_url(base_url, request_parameters)
        recipe_information_bad_request_reply = self.get_request(recipe_information_bad_request_url)
